# Code taken from https://genome.sph.umich.edu/wiki/LiftMap.py
...
def liftBed(fin, fout, funlifted):
    params = dict()
    params['LIFTOVER_BIN'] = '/usr/local/bin/liftOver'
    params['OLD'] = fin
    params['CHAIN'] = '/home/ryan/Data/liftover/hg18ToHg19.over.chain.gz'
    params['NEW'] = fout
